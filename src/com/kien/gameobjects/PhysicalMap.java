...
public class PhysicalMap extends GameObject {
    public int[][] phys_map;
    private int tileSize;       //chia map thành các hình vuông, 1 đại diện nơi có vật cản, 0 ngc lại, tilesize là độ dài 1 cạnh
    ...
    public Rectangle haveCollisionWithLand(Rectangle rect) {    //trả về hình cn bị va chạm

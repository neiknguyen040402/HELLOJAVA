...
public class ParticularObjectManager {
    ...
    public ParticularObjectManager(GameWorld gameWorld){
        ...
        particularObjects = Collections.synchronizedList(new LinkedList<ParticularObject>()); //đồng bộ hóa các luồng
    ...
    public void UpdateObjects(){
        ...
        synchronized(particularObjects){
            for(int id = 0; id < particularObjects.size(); id++){
                ...
                if(!object.isObjectOutOfCameraView()) object.Update();  //chỉ update những đối tg trong khung cam

...
import com.kien.effect.Animation;
...
public abstract class ParticularObject extends GameObject {
    ...
    public static final int BEHURT = 1;     //trạng thái bị đau
    public static final int FEY = 2;
    public static final int DEATH = 3;
    public static final int NOBEHURT = 4;    //trạng thái bất tử
    ...
    private int teamType;       //loại team

    private long startTimeNoBeHurt;      //tg bắt đầu bất tử
    private long timeForNoBeHurt;          //tg bất tử bao nhiêu s
    ...
    public boolean isObjectOutOfCameraView() {   //kiểm tra object có trong vùng view của camera ko(false nằm trong cam)
    ...
    public void beHurt(int damgeEat) { // gây sát thương cho chính đối tg này

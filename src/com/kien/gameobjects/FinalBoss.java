...
public class FinalBoss extends Human {
    ...
    private Hashtable<String, Long> timeAttack = new Hashtable<String, Long>();  //tên hành động và tg hành động đó
    private String[] attackType = new String[4];        //chuỗi hđ nhân vật
    private int attackIndex = 0;
    private long lastAttackTime;                      //thời điểm hđ kết thúc
